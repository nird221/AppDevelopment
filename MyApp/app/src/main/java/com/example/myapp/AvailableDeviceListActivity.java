...
public class AvailableDeviceListActivity extends AppUtility {
    ...
    private Boolean InsuranceMode = false;
    ...
    public void onBackPressed() {
        if (InsuranceMode) {
            Toast.makeText(AvailableDeviceListActivity.this, "Going back is not allowed in mode", Toast.LENGTH_SHORT).show();
        } else {
            super.onBackPressed();
        }
    }
    ...
    protected void onUserLeaveHint() {
        if (InsuranceMode) {
            Toast.makeText(getApplicationContext(), "Can't get out of the page while in mode", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private final BroadcastReceiver deviceConnectionBroadcast = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_ACL_CONNECTED.equals(action)) {
                ...
                Toast.makeText(getApplicationContext(), device.getName() + " connected - stop Insurance Mode", Toast.LENGTH_SHORT).show();
            ...
            // Check if a Bluetooth device has disconnected
                ...
                Toast.makeText(getApplicationContext(), device.getName() + " disconnected - start Insurance Mode", Toast.LENGTH_SHORT).show();
    ...
    private void startInsuranceMode() {
        Toast.makeText(getApplicationContext(), "Insurance Mode has started", Toast.LENGTH_SHORT).show();
    ...
    private void stopInsuranceMode() {
        Toast.makeText(getApplicationContext(), "Insurance Mode has stopped", Toast.LENGTH_SHORT).show();
