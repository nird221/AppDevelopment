...
public class UserHomePageActivity extends AppUtility {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBluetoothSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UserHomePageActivity.this, BluetoothSetUpActivity.class);
        ...
        btnSimulate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UserHomePageActivity.this, SimulateTimeBasedModeActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnDeviceList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UserHomePageActivity.this, AvailableDeviceListActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnAudioOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UserHomePageActivity.this, SimulateModeInCallActivity.class);
                startActivity(intent);
            }
        });
