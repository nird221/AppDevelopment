...
public class SetBluetoothActivity extends AppUtility {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(SetBluetoothActivity.this, android.R.layout.simple_list_item_1, arrayListpaired);
        detectedAdapter = new ArrayAdapter<String>(SetBluetoothActivity.this, android.R.layout.simple_list_item_single_choice);
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                checkPermission(Manifest.permission.BLUETOOTH, Consts.BLUETOOTH_PERMISSION_CODE);
                Toast.makeText(SetBluetoothActivity.this, "Start Searching...", Toast.LENGTH_SHORT).show();

                // Register for broadcasts when a device is discovered.
                IntentFilter intentFilter = new IntentFilter(BluetoothDevice.ACTION_FOUND);
                SetBluetoothActivity.this.registerReceiver(bluetoothSearchBroadcast, intentFilter);
    ...
    class ListItemClicked implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Toast.makeText(SetBluetoothActivity.this, "The Bond is created:" + isBonded, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    class ListItemClickedonPaired implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(SetBluetoothActivity.this);
            builder.setCancelable(true);
            builder.setTitle("Set YouKol Mode Device:");
            builder.setMessage("Would you like to set this Device to Youkol mode");
            builder.setPositiveButton("Confirm",
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(SetBluetoothActivity.this, MainActivity.class);
